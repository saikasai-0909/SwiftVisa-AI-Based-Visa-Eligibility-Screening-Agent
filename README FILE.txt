...
**"NOTE- INSTRUCTION FOR RUNNING THE PROJECT ": INSTALL ALL DEPENDENCIES AND THEN RUN vector_db.ipynb ONCE FOR LOADING THE CONTENTS OF THE VECTOR DB(chroma_db)  (since it caused error while pushing) AND THEN RUN THE app.py TO SUCESSFULLY RUN THE PROJECT.**
