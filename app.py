...
try:
    ...
    def get_agent_response(key, prompt):
        return "Backend connection missing. Please ensure visa_agent.py is present."
...
# >>> CASE 2: APPLICATION FORM <<<
    ...
    with st.form("eligibility_form"):
        ...
        if "Student" in visa_category:
            ...
            user_story = f"Visa: Student. Name: {full_name}. Nationality: {nationality}. Location: {location}. CAS: {has_cas}. CAS Ref: {cas_ref}. Course Level: {course_level}. Full Time: {full_time}. Start: {course_start}. End: {course_end}. Provider Licensed: {school_licensed}. Funds Held 28 Days: {funds_held}. English: {english}."
        ...
        # --- B. GRADUATE VISA LOGIC (Sources 20-28) ---
            ...
            user_story = f"Visa: Graduate. Name: {full_name}. In UK: {currently_in_uk}. Current Visa: {current_visa}. Completed: {course_completed}. Level: {course_level_comp}. Licensed: {uni_licensed}. Reported to HO: {reported}. Original CAS: {orig_cas}. Visa Valid: {visa_valid}."
        ...
        # --- C. SKILLED WORKER VISA LOGIC (Sources 41-53) ---
            ...
            user_story = f"Visa: Skilled Worker. Name: {full_name}. Job Offer: {job_offer}. Sponsor Licensed: {employer_licensed}. CoS Issued: {cos_issued}. CoS Ref: {cos_ref}. Job: {job_title}. SOC: {soc_code}. Eligible Job: {eligible_occ}. Salary: {salary}. Criminal Cert: {crim_cert}. English: {english}."
        ...
        # --- D. HEALTH & CARE VISA LOGIC (Sources 54-66) ---
            ...
            user_story = f"Visa: Health & Care. Name: {full_name}. Job Offer: {job_offer}. Licensed Sponsor: {employer_licensed}. CoS Ref: {cos_ref}. Job: {job_title}. SOC: {soc_code}. Eligible Role: {eligible_role}. Salary: {salary}. Prof Reg: {prof_reg}. English: {english}."
        ...
        # --- E. VISITOR VISA LOGIC (Sources 67-75) ---
            ...
            user_story = f"Visa: Visitor. Name: {full_name}. Purpose: {purpose}. Stay: {stay_months} months. Accommodation: {accommodation}. Onward Travel: {onward_travel}. Funds: {funds_visit}. Intent to Leave: {intent_leave}."
